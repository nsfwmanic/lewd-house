...
define config.name = _("The Lewd House Alpha Build")
...
define build.name = "TheLewdHouseAlphaBuild"
...
define config.save_directory = "THELEWDHOUSELEGEDARYEDITIO-1477770581"
...
init python:
    ...
    build.classify('game/**.rar', 'archive')
